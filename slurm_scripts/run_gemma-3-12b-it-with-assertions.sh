...
#SBATCH --output=logs/score_google_gemma-3-12b-it_assertions_%j.out
#SBATCH --error=logs/score_google_gemma-3-12b-it_assertions_%j.err
#SBATCH --job-name=score_google_gemma-3-12b-it-assertions
...
python score_dataset.py --model_name "google/gemma-3-12b-it" -I data/generated_assertions_v2_1000.jsonl --query_only
