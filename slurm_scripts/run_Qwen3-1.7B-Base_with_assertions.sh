...
#SBATCH --job-name=score_Qwen3-1.7B-Base_with_assertions
...
python score_dataset.py --model_name "Qwen/Qwen3-1.7B-Base" -I data/generated_assertions_v2_full.jsonl --use_generate
