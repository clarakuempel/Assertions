...
#SBATCH --output=logs/score_google_gemma-3-12b-pt_%j.out
#SBATCH --error=logs/score_google_gemma-3-12b-pt_%j.err
#SBATCH --job-name=score_google_gemma-3-12b-pt
...
python score_dataset.py --model_name "google/gemma-3-12b-pt"
