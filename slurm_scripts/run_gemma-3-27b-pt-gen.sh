...
#SBATCH --output=logs/score_google_gemma-3-27b-pt_gen_%j.out
#SBATCH --error=logs/score_google_gemma-3-27b-pt_gen_%j.err
#SBATCH --job-name=score_google_gemma-3-27b-pt-gen
...
python score_dataset.py --model_name "google/gemma-3-27b-pt" --use_generate
