...
#SBATCH --output=logs/score_meta-llama_Llama-3.2-1B-Instruct_assertions_%j.out
#SBATCH --error=logs/score_meta-llama_Llama-3.2-1B-Instruct_assertions_%j.err
#SBATCH --job-name=score_meta-llama_Llama-3.2-1B-Instruct-assertions
...
python score_dataset.py --model_name "meta-llama/Llama-3.2-1B-Instruct" -I data/generated_assertions_v2_1000.jsonl --query_only
