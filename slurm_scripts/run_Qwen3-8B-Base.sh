...
#SBATCH --output=logs/score_Qwen_Qwen3-8B-Base_%j.out
#SBATCH --error=logs/score_Qwen_Qwen3-8B-Base_%j.err
#SBATCH --job-name=score_Qwen_Qwen3-8B-Base
...
python score_dataset.py --model_name "Qwen/Qwen3-8B-Base"
