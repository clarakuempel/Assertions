...
#SBATCH --output=logs/score_Qwen3-30B-A3B-Base_with_assertions_%j.out
#SBATCH --error=logs/score_Qwen3-30B-A3B-Base_with_assertions_%j.err
#SBATCH --job-name=score_Qwen3-30B-A3B-Base_with_assertions
...
python score_dataset.py --model_name "Qwen/Qwen3-30B-A3B-Base" -I data/generated_assertions_v2_full.jsonl --use_generate
