...
#SBATCH --output=logs/score_Llama-3.1-8B_query_only_%j.out
#SBATCH --error=logs/score_Llama-3.1-8B_query_only_%j.err
#SBATCH --job-name=score_Llama-3.1-8B_query_only
...
python score_dataset.py --model_name "meta-llama/Llama-3.1-8B" -I data/generated_assertions_v2_full.jsonl --query_only --use_generate
