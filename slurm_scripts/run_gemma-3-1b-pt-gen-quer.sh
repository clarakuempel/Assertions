...
#SBATCH --output=logs/score_google_gemma-3-1b-pt_%j.out
#SBATCH --error=logs/score_google_gemma-3-1b-pt_%j.err
#SBATCH --job-name=score_google_gemma-3-1b-pt
...
python score_dataset.py --model_name "google/gemma-3-1b-pt" -I data/generated_assertions_v2_1000.jsonl --use_generate --query_only
