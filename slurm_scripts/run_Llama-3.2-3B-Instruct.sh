...
#SBATCH --output=logs/score_meta-llama_Llama-3.2-3B-Instruct_%j.out
#SBATCH --error=logs/score_meta-llama_Llama-3.2-3B-Instruct_%j.err
#SBATCH --job-name=score_meta-llama_Llama-3.2-3B-Instruct
...
python score_dataset.py --model_name "meta-llama/Llama-3.2-3B-Instruct"
