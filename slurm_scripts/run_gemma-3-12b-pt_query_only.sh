...
#SBATCH --job-name=score_gemma-3-12b-pt_query_only
...
python score_dataset.py --model_name "google/gemma-3-12b-pt" -I data/generated_assertions_v2_full.jsonl --query_only --use_generate
