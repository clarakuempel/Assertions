...
#SBATCH --output=logs/score_meta-llama_Llama-3.1-8B_%j.out
#SBATCH --error=logs/score_meta-llama_Llama-3.1-8B_%j.err
#SBATCH --job-name=score_meta-llama_Llama-3.1-8B
