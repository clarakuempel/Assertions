...
#SBATCH --output=logs/score_Qwen_Qwen3-1.7B-Base_assertions_%j.out
#SBATCH --error=logs/score_Qwen_Qwen3-1.7B-Base_assertions_%j.err
#SBATCH --job-name=score_Qwen_Qwen3-1.7B-Base-assertions
...
python score_dataset.py --model_name "Qwen/Qwen3-1.7B-Base" -I data/generated_assertions_v2_1000.jsonl --query_only
