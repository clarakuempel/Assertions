...
#SBATCH --output=logs/score_Qwen_Qwen3-30B-A3B_%j.out
#SBATCH --error=logs/score_Qwen_Qwen3-30B-A3B_%j.err
#SBATCH --job-name=score_Qwen_Qwen3-30B-A3B
...
python score_dataset.py --model_name "Qwen/Qwen3-30B-A3B" -I data/generated_assertions_v2_1000.jsonl --use_generate
