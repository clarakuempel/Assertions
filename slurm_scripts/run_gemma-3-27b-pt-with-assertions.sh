...
#SBATCH --time=4:00:00
#SBATCH --output=logs/score_google_gemma-3-27b-pt_assertions_%j.out
#SBATCH --error=logs/score_google_gemma-3-27b-pt_assertions_%j.err
#SBATCH --job-name=score_google_gemma-3-27b-pt-assertions
...
python score_dataset.py --model_name "google/gemma-3-27b-pt" -I data/generated_assertions_v2_1000.jsonl --query_only
