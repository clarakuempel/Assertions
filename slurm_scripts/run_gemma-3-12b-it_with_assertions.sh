...
#SBATCH --output=logs/score_gemma-3-12b-it_with_assertions_%j.out
#SBATCH --error=logs/score_gemma-3-12b-it_with_assertions_%j.err
#SBATCH --job-name=score_gemma-3-12b-it_with_assertions
...
python score_dataset.py --model_name "google/gemma-3-12b-it" -I data/generated_assertions_v2_full.jsonl --use_generate
