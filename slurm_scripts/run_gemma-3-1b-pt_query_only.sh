...
#SBATCH --output=logs/score_gemma-3-1b-pt_query_only_%j.out
#SBATCH --error=logs/score_gemma-3-1b-pt_query_only_%j.err
#SBATCH --job-name=score_gemma-3-1b-pt_query_only
...
python score_dataset.py --model_name "google/gemma-3-1b-pt" -I data/generated_assertions_v2_full.jsonl --query_only --use_generate
