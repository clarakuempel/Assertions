...
#SBATCH --output=logs/score_google_gemma-3-27b-it_gen_%j.out
#SBATCH --error=logs/score_google_gemma-3-27b-it_gen_%j.err
#SBATCH --job-name=score_google_gemma-3-27b-it-gen
...
python score_dataset.py --model_name "google/gemma-3-27b-it" --use_generate
