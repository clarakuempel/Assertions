...
#SBATCH --output=logs/score_Llama-3.2-3B_query_only_%j.out
#SBATCH --error=logs/score_Llama-3.2-3B_query_only_%j.err
#SBATCH --job-name=score_Llama-3.2-3B_query_only
...
python score_dataset.py --model_name "meta-llama/Llama-3.2-3B" -I data/generated_assertions_v2_full.jsonl --query_only --use_generate
