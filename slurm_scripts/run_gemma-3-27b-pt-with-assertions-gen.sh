...
#SBATCH --output=logs/score_google_gemma-3-27b-pt_assertions_gen_%j.out
#SBATCH --error=logs/score_google_gemma-3-27b-pt_assertions_gen_%j.err
#SBATCH --job-name=score_google_gemma-3-27b-pt-assertions-gen
...
python score_dataset.py --model_name "google/gemma-3-27b-pt" -I data/generated_assertions_v2_1000.jsonl --query_only --use_generate
