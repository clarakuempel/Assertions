...
#SBATCH --output=logs/score_Llama-3.2-3B_with_assertions_%j.out
#SBATCH --error=logs/score_Llama-3.2-3B_with_assertions_%j.err
#SBATCH --job-name=score_Llama-3.2-3B_with_assertions
...
python score_dataset.py --model_name "meta-llama/Llama-3.2-3B" -I data/generated_assertions_v2_full.jsonl --use_generate
