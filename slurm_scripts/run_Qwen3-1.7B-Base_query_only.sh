...
#SBATCH --output=logs/score_Qwen3-1.7B-Base_query_only_%j.out
#SBATCH --error=logs/score_Qwen3-1.7B-Base_query_only_%j.err
#SBATCH --job-name=score_Qwen3-1.7B-Base_query_only
...
python score_dataset.py --model_name "Qwen/Qwen3-1.7B-Base" -I data/generated_assertions_v2_full.jsonl --query_only --use_generate
